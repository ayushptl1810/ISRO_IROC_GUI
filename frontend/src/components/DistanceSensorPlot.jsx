...
const DistanceSensorPlot = () => {
  ...
  useEffect(() => {
    ...
    // Get distance sensor data (using the same D0 and D1 for demonstration)
    // In a real scenario, you might have separate distance sensors
    ...
    ctx.font = "12px Arial";
    ctx.fillText("Distance 1", padding, 20);
    ctx.fillStyle = "#10b981";
    ctx.fillRect(padding + 80, 10, 20, 10);
    ctx.fillStyle = "#ffffff";
    ctx.fillText("Distance 2", padding + 110, 20);
    ctx.fillStyle = "#f59e0b";
    ctx.fillRect(padding + 170, 10, 20, 10);
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Distance Sensors Over Time</h2>
